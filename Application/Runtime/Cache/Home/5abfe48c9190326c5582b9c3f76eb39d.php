			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$v): ?><li>
						<dl>
							<dt>
								<a href="<?php echo U('detail',array('goods_id'=>$v['goods_id']));?>" target="_blank"><img src="<?php echo (substr($v["goods_small_logo"],1)); ?>" alt="" /></a>
							</dt>
							<dt>
								<a href="<?php echo U('detail',array('goods_id'=>$v['goods_id']));?>" target="_blank"><?php echo ($v["goods_name"]); ?></a>
							</dt>
							<dt><strong>￥<?php echo ($v["goods_price"]); ?></strong></dt>
							<!-- <?php if(($v["goods_id"]) == $secId): ?><dt>秒杀...</dt><?php endif; ?> -->
							<?php if(in_array(($v["goods_id"]), is_array($secId)?$secId:explode(',',$secId))): ?><dt style="color:#f00;">秒杀...</dt><?php endif; ?>
