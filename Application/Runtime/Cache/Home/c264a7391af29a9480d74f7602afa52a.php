...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
                            <ul>
                    <li>您好，欢迎来到京西！[<a href="/User/login.html">登录</a>] [<a href="/User/regist.html">免费注册</a>] </li>
                    <li class="line">|</li>
                    <li>我的订单</li>
                    <li class="line">|</li>
                    <li>客户服务</li>
...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        ...
        <div class="cart fl">
            <dl>
                <dt>
                    <a href="/Shop/flow1.html" target="_blank">去购物车结算</a>
                    <b></b>
                </dt>
                <dd>
                    <div class="prompt">
    ...
    <div class="nav w1210 bc mt10">
        <!--  商品分类部分 start-->
                    ...
                    <div class="cat_bd none">                <div class="cat item1">
        ...
        <div class="navitems fl">
            <ul class="fl">
                ...
                <li><a href="">电脑频道</a></li>
                <li><a href="">家用电器</a></li>
                <li><a href="/Goods/showlist.html" target="_blank">品牌大全</a></li>
                <li><a href="">团购</a></li>
                <li><a href="">积分商城</a></li>
                <li><a href="">夺宝奇兵</a></li>
            </ul>
...
<div class="main w1210 mt10 bc">
	...
	<div class="goods_content fl mt10 ml10">
		<!-- 商品概要信息 start -->
		<div class="summary">
			<h3><strong>小米手机6</strong></h3>

			<!-- 图片预览区域 start -->
			<div class="preview fl">
				<div class="midpic">
					<a href="/Public/Uploads/pics/2017-07-11/big_5964b84fcd9cb.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
						<img src="/Public/Uploads/pics/2017-07-11/mid_5964b84fcd9cb.jpg" alt="" />               <!-- 第一幅图片的中图 -->
					</a>
				</div>
				...
				<div class="smallpic">
					...
					<div class="smallpic_wrap">
						<ul>
							<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Public/Uploads/pics/2017-07-11/mid_5964b84fcd9cb.jpg',largeimage: '/Public/Uploads/pics/2017-07-11/big_5964b84fcd9cb.jpg'}"><img src="/Public/Uploads/pics/2017-07-11/small_5964b84fcd9cb.jpg"></a>
									</li>
			...
			<!-- 图片预览区域 end -->
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span>52</li>
						<li class="market_price"><span>定价：</span><em>￥4000</em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥3780.00</strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span>2017-07-11</li>
					...
					<form action="" method="post" class="choose">
						...
						<li class="product">
								<dl>
									<dt>显卡：</dt>
									<dd>
										<a class="selected" href="javascript:;">GTX1060 8G <input type="radio" name="color" value="GTX1060 8G" checked="checked" /></a>
																					</dd>
								</dl>
							</li>							<!--添加一个商品数量增减的操作框-->
							<li>
		...
		<div class="detail">
			...
			<div class="detail_bd">
				...
				<div class="introduce detail_div none">
					<div class="attr mt15">
						<ul>
							<li><span>cpu：</span>231</li><li><span>颜色：</span>红</li>						</ul>
					</div>

					<div class="desc mt10">
						<!-- 此处的内容 一般是通过在线编辑器添加保存到数据库，然后直接从数据库中读出 -->
						<img src="/ueditor/php/upload/image/20170711/1499772963832320.jpg" alt="7f9e9b4dgw1eb5kfcy7eej20fa0fsdi9.jpg" />
					</div>
				</div>
				<!-- 商品介绍 end -->
...
<div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
	...
	<p>
		<a href="/Shop/flow1.html" onclick="javascript:hideElement('cartBox')" class="bt_orange" target="_blank"></a>
