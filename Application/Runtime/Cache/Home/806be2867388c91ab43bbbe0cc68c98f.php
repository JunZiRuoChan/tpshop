    ...
    <div class="main w1210 bc mt10">
        ...
        <div class="content fl ml10">
            ...
            <div class="order_bd mt10">
                <?php if(is_array($showlistInfo)): foreach($showlistInfo as $key=>$order): ?><table class="orders">
                    <tbody>

                        <tr>
                            <td colspan="2">订单号:<?php echo ($order["order_number"]); ?></td>
                                <?php if(is_array($order['orderDetails'])): foreach($order['orderDetails'] as $key=>$detail): ?><tr>
                            <td  ><a href="/index.php/Home/goods/detail/goods_id/<?php echo ($detail['goods_id']); ?>"><img src="<?php echo ($detail["goods_small_logo"]); ?>" alt="<?php echo ($detail["goods_name"]); ?>"></a></td>
                                    <td><a href="/index.php/Home/goods/detail/goods_id/<?php echo ($detail['goods_id']); ?>"><?php echo ($detail["goods_name"]); ?></a>&nbsp;&nbsp;￥<?php echo ($detail["goods_price"]); ?>&nbsp;&nbsp;<p>x<?php echo ($detail["order_goods_number"]); ?><p></td>
                                </tr><?php endforeach; endif; ?>
                            <!--<td><?php echo ($order["order_number"]); ?></td>-->
                            <td colspan="2"><?php echo (date("Y-m-d H:i:s",$order["add_time"])); ?>&nbsp;&nbsp;
                            <?php echo ((isset($order['order_pay']) && ($order['order_pay'] !== ""))?($order['order_pay']):''); ?>支付:￥<?php echo ($order["order_price"]); ?>&nbsp;&nbsp;<?php echo ($order["order_status"]); ?> <a href="/index.php/Home/Order/OrderDetail/order_id/<?php echo ($order["order_id"]); ?>">查看</a> | <a href="">删除</a></td>
                        </tr>
                    </tbody>
                </table>
        <div style="height: 5px;"></div><?php endforeach; endif; ?>
            </div>
        </div>
        <!-- 右侧内容区域 end -->
    </div>
