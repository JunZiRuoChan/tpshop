			...
			<!-- 图片预览区域 end -->
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<!-- <li><?php if(in_array(($goodsinfo["goods_id"]), is_array($secId)?$secId:explode(',',$secId))): ?><span style="color:#f00;">秒杀商品</span><?php endif; ?></li><br> -->
						...
						<?php if(is_array($manyinfo)): foreach($manyinfo as $key=>$v): ?><li class="product">
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
										<input type="button" value="" id="add_btn" class="add_btn" onclick="add_cart(<?php echo ($goodsinfo["goods_id"]); ?>)" />
									</dd>
								</dl>
							</li>
							...
							<li>
								<dl>
									<?php if(in_array(($goodsinfo["goods_id"]), is_array($secId['goods_id'])?$secId['goods_id']:explode(',',$secId['goods_id']))): ?><dt style="color:#f00;">秒杀倒计时：</dt>
										<dd><?php echo ($secTime); ?>秒</dd><?php endif; ?>
								</dl>
							</li>
<script>
	//给购物车添加商品
