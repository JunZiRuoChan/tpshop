		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select">
					<ul>
						<li class="cur">
							<input type="radio" name="cgn_id" checked="checked" value="32" />王小二 北京市 昌平区 建材城西路金燕龙办公楼一层 13555555555
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
						<li>
							<input type="radio" name="cgn_id" value="35" />王小二 湖北省 武汉市  武昌 关山光谷软件园1号201 13333333333
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
			...
			<div class="goods">
				...
				<table>
					...
					<?php if(is_array($cartinfo)): foreach($cartinfo as $key=>$v): ?><tr>
							<td class="col1" style="text-align:center;"><a href=""><img src="<?php echo (substr($v["logo"],1)); ?>" alt="" /></a>  <strong><a href=""><?php echo ($v["goods_name"]); ?></a></strong></td>
