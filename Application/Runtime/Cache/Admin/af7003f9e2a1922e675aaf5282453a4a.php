                    ...
                    <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="94%" valign="bottom"><span class="STYLE1"> 类型管理 -> 类型列表</span></td>
                            </tr>
                        </table></td>
    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($v["type_name"]); ?></span></div></td>
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
                        <a href="<?php echo U('Attribute/showlist',array('type_id'=>$v['type_id']));?>" style="color:rgb(59,99,117)">属性列表</a> | <img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> <a href="<?php echo U('del',array('type_id'=>$v['type_id']));?>" style="color:rgb(59,99,117)" onclick="return confirm('确认删除？')">删除</a> | 查看 | <a href="<?php echo U('upd',array('type_id'=>$v['type_id']));?>" style="color:rgb(59,99,117)"><img src="<?php echo C('AD_IMG_URL');?>edit.gif" width="10" height="10" /> 编辑</a></div></td>
