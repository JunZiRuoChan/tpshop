                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show">
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
                            <input type="text" name="auth_name" value="<?php echo ($authinfo["auth_name"]); ?>"/>
                        </div></td>
                    </tr>
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
                            <select name="auth_pid">
                                ...
                                <?php if(is_array($authinfos)): foreach($authinfos as $key=>$v): ?><option value="<?php echo ($v["auth_id"]); ?>" <?php if(($v["auth_id"]) == $authinfo["auth_pid"]): ?>selected = "selected"<?php endif; ?>><?php echo ($v["auth_name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div></td>
                    </tr>
                    <tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">控制器：</span></div></td>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><input type="text" name="auth_c" value="<?php echo ($authinfo["auth_c"]); ?>"/></div></td>
                    </tr>
                    <tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">操作方法：</span></div></td>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left"><input type="text" name="auth_a" value="<?php echo ($authinfo["auth_a"]); ?>"/></div></td>
                    </tr>
                </table>
