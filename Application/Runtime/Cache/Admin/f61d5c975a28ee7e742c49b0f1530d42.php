          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 会员管理 -> 修改会员级别</span></td>
              </tr>
            </table></td>
    ...
    <td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show" >
        <tr>
          ...
          <input type="text" name="level_name" id="level_name" value="<?php echo $memberLevelInfo['level_name'] ?>"/>
        ...
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
            <input type="text" name="level_rate" id="level_rate" value="<?php echo $memberLevelInfo['level_rate'] ?>" />
          ...
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
            <input type="text" name="jifen_bottom" id="jifen_bottom" value="<?php echo $memberLevelInfo['jifen_bottom'] ?>" />
          ...
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
            <input type="text" name="jifen_top" id="jifen_top" value="<?php echo $memberLevelInfo['jifen_top'] ?>" />
          </div>
          </td>
        </tr>
    </table>
      ...
      <tr>
        ...
        <input type="submit" value="修改" id="level" />
        </td>
      </tr>
    </table>
    </form>
