            ...
            <form action="" method="post" enctype="multipart/form-data">
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show">
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
                            <input type="radio" value="only" name="attr_sel" />唯一属性
                            <input type="radio" value="many" name="attr_sel" />单选属性
                        </div></td>
                    </tr>
                    <tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">属性值录入方式：</span></div></td>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
                            <input type="radio" checked="checked" value="manual" name="attr_write" />手工录入
                            <input type="radio" value="list" name="attr_write" />从下拉列表选取
                        </div></td>
                    </tr>
                    <tr>
