      ...
      <?php if(is_array($data["list"])): foreach($data["list"] as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF">
          <div align="center" class="STYLE21">
            ...
            <a href="<?php echo U('delete',array('goods_id'=>$v['goods_id']));?>" style="color:rgb(59,99,117)">删除</a> |
            <a href="javascript:;" class="statePage" style="color:rgb(59,99,117)">静态化</a> |
            <a href="<?php echo U('setsecBuy',array('goods_id'=>$v['goods_id']));?>" class="secbuy" style="color:rgb(59,99,117)">开启秒杀</a> |
            <a href="<?php echo U('upd',array('goods_id'=>$v['goods_id']));?>" style="color:rgb(59,99,117)">
